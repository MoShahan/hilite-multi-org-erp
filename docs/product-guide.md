...
**Audience:** Product owners, stakeholders, assessors, and developers who need to understand _what_ the product does (not how it is built).
...
| `PLATFORM_USER_CREATED`     | _(platform audit only)_      | Admin    |
