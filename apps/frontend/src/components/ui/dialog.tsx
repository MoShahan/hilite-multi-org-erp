...
const getOutsideEventTarget = (event: Event): HTMLElement | null => {
...
const preventDialogDismissForPortaledControls = (event: Event) => {
      ...
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          onPointerDownOutside={(event) => {
            preventDialogDismissForPortaledControls(event);
            onPointerDownOutside?.(event);
          }}
